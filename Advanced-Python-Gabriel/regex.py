...
#the caret ^ matches text at the beginning of a line. The following group, the part with (From|To|Cc) 
#means that the line has to start with one of the words that are separated by the pipe |. 
